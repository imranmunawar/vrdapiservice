...
Route::group(['namespace' => 'Api\V1','middleware' => 'auth:api'], function () {
    ...
    Route::post('/recruiter/available/slots', 'RecruiterSchedulingController@getRecruiterAvailableSlots');
...
Route::group(['namespace' => 'Api\V1'], function () {
    ...
    Route::post('/front/join/interview',[
       'uses' => 'RecruiterSchedulingController@candidateFrontInterview',
       'as'   => 'candidateFrontInterview'
    ]);
