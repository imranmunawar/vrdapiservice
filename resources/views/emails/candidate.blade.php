                                ...
                                <tr>
                                    ...
                                    <td valign="top" width="560" style="font-family:Arial,helvetica,sans-serif;font-weight:normal;font-size:12px;line-height:19px;color:#666666">
                                        ...
                                        <p style="color:#666666;font-family:Arial,helvetica,sans-serif;font-size:12px;font-weight:normal;margin-bottom:20px;margin-top:0px">
                                            <p>Thank You for registering to the {{ $fairname }}. You have now successfully registered to attend for the Virtual recruitment day event on <a href="https://calendar.google.com/calendar/r/eventedit?dates={{$calendar_time}}&text={{ $fairname }}&location={{ url('/'.$url) }}&details=&pli=1&sf=true" style="color: #666;font-size: 14px;text-decoration: none;border-bottom: 1px dotted;">{{$time}}</a>. </p>
											<p>We will send you a notification when fair goes live. On the day you will be able to Apply for live Jobs based on your matches and interact with recruiters directly in a Virtual Environment.</p>
											<br>
                                            <b>Here is your login details</b>
											<br>
											Email: {{ $email }}
                                        </p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="margin-bottom:20px">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="center" valign="middle" style="">
                                                        <a style="background-color:#5D2DDC;border-radius:2px;color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:bold;line-height:150%;padding:10px 10px;text-decoration:none;" href="{{$candidateLoginUrl}}" target="_blank">Click to Login</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <tr class="m_-7922248444950610321debug">
                        <td>
                            <p style="text-align:center;color:#616161;font-size:9px;line-height:15px;font-family:Arial,Verdana,sans-serif">
                                ...
                                <br>
                                <small style="font-size:9px">
                                    <a href="{{ url('/email/unsubscribe/'.$faircandidate_id.'/'.$candidate_id) }}"> Unsubscribe</a>
                                </small>
