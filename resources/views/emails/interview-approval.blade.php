                                ...
                                <tr>
                                    ...
                                    <td valign="top" width="560" style="font-family:Arial,helvetica,sans-serif;font-weight:normal;font-size:12px;line-height:19px;color:#666666">
                                        <h2 style="color:#5D2DDC;font-family:Arial,helvetica,sans-serif;font-size:18px;line-height:28px;font-weight:bold;margin-bottom:10px">
                                            Your interview has schedule with {{$candidateName}} at {{ $date }} from {{ $start_time }} to {{ $end_time }} in {{ $fairname }}
                                        </h2>
                                        <p style="color:#666666;font-family:Arial,helvetica,sans-serif;font-size:12px;font-weight:normal;margin-bottom:20px;margin-top:0px">
                                            <p>Please click on the approve now button to confirm the interview with the candidate.</p>
                                        </p>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="center" valign="middle" style="">
                                                        <a style="background-color:#5D2DDC;border-radius:2px;color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:bold;line-height:150%;padding:10px 10px; margin-right: 5px;text-decoration:none;" href="https://calendar.google.com/calendar/r/eventedit?dates={{$calendar_time}}&text={{ $fairname }}&location={{ $frontFairUrl }}&details=&pli=1&sf=true" target="_blank">Add to Calendar</a>
                                                    </td>
                                                    <td align="center" valign="middle" style="">
                                                        <a style="background-color:#5D2DDC;border-radius:2px;color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:bold;line-height:150%;padding:10px 10px;text-decoration:none;margin-right: 5px" href="{{ $backendLogin }}" target="_blank">Approve Now</a>
                                                    </td>
                                                    <td align="center" valign="middle" style="">
                                                        <a style="background-color:#5D2DDC;border-radius:2px;color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:bold;line-height:150%;padding:10px 10px;text-decoration:none;" href="{{ $backendLogin }}" target="_blank">Click to Login</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <p style="color:#666666;font-family:Arial,helvetica,sans-serif;font-size:12px;font-weight:normal;margin-bottom:20px;margin-top:0px">
                                            If you want to cancel that interview, please click this link anytime. <a href="{{ $cancelUrl }}" style="color:#0083be;text-decoration:none" target="_blank">Cancel Interview</a>.
                                        </p>
